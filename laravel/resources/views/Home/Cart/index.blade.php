            ...
            <div id='js-cart-body-table' class='cart-body-table'>
                @foreach($cart as $val)
                    <div class='item clearfix js-item-cart js-each-122'>
                        <div class='item-1'>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" class='js-check imv2-checkbox_onk check goods-check GoodsCheck' value='{{ $val->price }},{{ $val->sid }},{{ $val->course_name }}' name="box" onclick="jisuan(this)" id="{{ $val->sid }}">
                        </div>
                        <div class='item-2 clearfix'>
                            <a href="http://coding.imooc.com/class/122.html" target="_blank" class="img-box l">
                                <img src='{{ $val->course_img }}' width='160' height='90'/>
                            </a>
