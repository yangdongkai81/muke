                    ...
                    <ul class="js-itemUl item-ul" style="height: 150px;">
                        ...
                        <li class="item clearfix" data-cid="$info.type_id">
                            ...
                            <div class="item-left left clearfix">
                                <a href="http://coding.imooc.com/class/130.html" target="_blank"><img src="/public/uploads/{{ $img }}" class="left" width="160" height="90"></a>
        ...
        $(document).on('click','.pay',function(){
            ...
            $.ajax({
                ...
                success:function (msg) {
                    if(msg==1){
                        alert('支付成功');
                        window.location.href="{{url('charge_index')}}";
                    }else{
                        alert('支付失败');
                    }
                }
