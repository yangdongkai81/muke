...
<meta name="Keywords" content="积分商城,慕课网,慕课社区" />


<meta name="Description" content="积分商城,专为慕课网网友提供的慕课商品兑换中心" />
...
<link rel="stylesheet" href="/static/moco/v1.0/dist/css/moco.min.css?t=201708319527" type="text/css" />
...
var OP_CONFIG={"module":"mall","page":"index","userInfo":{"uid":"5760367","nickname":"qq_\u6ca1\u6709\u5982\u679c_33","head":"http:\/\/img.mukewang.com\/user\/59a6ad970001c04901000100-80-80.jpg","usertype":"1","roleid":0}};
var isLogin = 1;
var is_choice = "";
var seajsTimestamp="v=201708319527";
var _msg_unread = 0; 
var _not_unread = 0; 
var _cart_num = 0;
</script>
...
<div id="header">
    <div class="page-container" id="nav"  >
        ...
        <ul class="nav-item">
                        <li class="set-btn visible-xs-block js-header-avator"><a href="/u/5760367" target="_self"><img width="40" height="40"></a></li>
            ...
            <ul class="clearfix logined">
                ...
                <li class='remind_warp'>
                    ...
                    <a target="_blank" href='/u/5760367/notices'>
                ...
                <li class="set_btn user-card-box" id='header-user-card'>
                    <a id="header-avator" class="user-card-item js-header-avator" action-type="my_menu"  href="/u/5760367" target="_self">
		...
		<h2 class="page-title">
			...
			<div class="bd l">
				<ul>
					...
					<li class="course-nav-item on"><a href="{{url('fictitious')}}">虚拟商品</a></li>
...
<div class="mall-right r">
      <div class="panel">      
          ...
          <a href="/u/5760367/credit" title="" class="sharer-name">qq_没有如果_33</a>
          <a href="/u/5760367/credit" class="shared-page jf-num">当前积分：<span id="js-my-credit">0</span></a>
...
<script type="text/javascript" src="/static/sea_config.js?v=201708319527"></script>
