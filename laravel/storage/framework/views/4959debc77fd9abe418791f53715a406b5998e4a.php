...
<a href='http://home.wolive.cc' user_id='' username='' avatar='' web_id='fuhei' id='workerman-kefu'></a>
    ...
    #boss-cta .boss-button a:hover{
        ...
        <link rel="stylesheet" href="http://static.mukewang.com/static/css/??base.css,common/common-less.css?t=2.5,wenda/wenda-less.css?v=201708281028" type="text/css" />
    </head>
    <body >
    ...
    <div id="header">
        <div class="page-container" id="nav"  >
            <div class="beijing">
            <div id="logo" class="logo"><a href="<?php echo e(url('index_index')); ?>" target="_self" class="hide-text" title="首页">慕课网</a></div>
            ...
            <div id="login-area">
                <ul class="header-unlogin clearfix">
                    ...
                    <img src="/public/images/404_bg.png" width="50px" height="50px"><span style="color:white;">邮箱:<?php echo e(\Session::get('email')); ?></span>
                                    <div class="cent" > 
