...
<div class="course-class-infos ">
    <div class="w pr">
		<div class="path">
			...
			<i class="path-split">\</i><span><?php echo e($ke[0]->course_name); ?></span>
		</div>
		...
		<div class="info-warp tc">
			<div style="height:50px;">
				<h1 style="font:50px/0.1 Tahoma,Helvetica,Arial,'宋体',sans-serif;"><?php echo e($ke[0]->course_name); ?></h1>
			</div>
			...
			<div class="price-box">
				<span class="num clearfix">
						...
						<span class="cur-price"><b><?php echo e($ke[0]->price); ?></b><b class="sub">.00</b></span>
						</span>
					</span>
			...
			<?php if ($is_show!=0) { ?>
			    <a href="<?php echo e(url('course_learn').'/'.$ke[0]->id); ?>" class="js-buy-trigger buy-class-btn class-btn1 buynow-btn" data-cid="135" data-pay="0" id="buy-trigger">
						<span>立即播放</span>
					</a>
			<?php }else{ ?>

                	<a href="<?php echo e(url('cart_add')); ?>/<?php echo e($ke[0]->id); ?>" class="js-buy-trigger buy-class-btn class-btn1 buynow-btn" data-cid="135" data-pay="0" id="buy-trigger">
						<span>立即购买</span>
					</a>
			<?php	} ?>
     				<!-- <a href="<?php echo e(url('cart_add')); ?>/<?php echo e($ke[0]->id); ?>" class="js-buy-trigger buy-class-btn class-btn1 buynow-btn" data-cid="135" data-pay="0" id="buy-trigger">
...
</div><input type="hidden" id="kid" value="<?php echo e($kid); ?>">     <?php echo e(csrf_field()); ?>
 ...
 <div id="sh"  style="width:700px;margin:0 auto;display:none;" >
     <?php foreach ($zhang as $key => $v) {?>
            ...
            <div class="mod-chapters" >
                    ...
                    <!-- 章节标题 end -->
                    <!-- 章节小节 -->
                                        <ul class="video video<?php echo e($v->id); ?>"   >
