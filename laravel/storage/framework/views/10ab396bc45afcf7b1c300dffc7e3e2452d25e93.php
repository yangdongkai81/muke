    ...
    <div class="w index-main">
        ...
        <div class="cato-wrap-box clearfix">
                    ...
                    <ul class="">
                        ...
                        <?php foreach($type as $val): ?>
                            <li class="cato-nav-item ">
                                <a href="<?php echo e(url('charge_fang')); ?>/<?php echo e($val->id); ?>" data-ct="op"><?php echo e($val->aspect_name); ?></a>
                            </li>
                        <?php endforeach; ?>
            ...
            <div class="skill-nav-box l">
                ...
                <div class="cato-nav-row">
                    <ul class="">
                        <?php foreach($direction as $v): ?>
                            <li class="cato-nav-item ">
                                <a href="<?php echo e(url('charge_sofen')); ?>/<?php echo e($val->id); ?>" data-ct="html"><?php echo e($v->aspect_name); ?></a>
                            </li>
                        <?php endforeach; ?>
