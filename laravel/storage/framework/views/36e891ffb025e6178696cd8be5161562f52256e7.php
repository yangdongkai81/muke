...
<div class="course-class-infos ">
    <div class="w pr">
		<div class="path">
			...
			<i class="path-split">\</i><span>PHP开发高可用高安全App后端</span>
		</div>
		...
		<div class="info-warp tc">
			...
			<div class="hide">
				<h1 class="l">PHP开发高可用高安全App后端</h1>
			</div>
			...
			<div class="price-box">
				<span class="num clearfix">
						...
						<span class="cur-price"><b>266</b><b class="sub">.00</b></span>
						</span>
					</span>
			...
			<div class="clearfix btnwarp">
														<a href="javascript:;" class="js-buy-trigger buy-class-btn class-btn1 buynow-btn" data-cid="135" data-pay="0" id="buy-trigger">
						<span>立即购买</span>
					</a>
    ...
    <div class="info-bg" id="js-info-bg">
        <div class="cover-img-wrap" style="background-image:url(http://szimg.mukewang.com/59ae66c00001a1dc20000520.jpg)"></div>     
    </div>
</div>
...
<div class="comp-tab-t js-comp-tab">
	<ul class="clearfix">
		<li class="comp-tab-item-first comp-tab-item active">
			<a href="http://coding.imooc.com/class/135.html#Anchor">课程介绍</a>
		</li>
				<li class="comp-tab-item ">
			<a href="http://coding.imooc.com/class/chapter/135.html#Anchor">课程章节</a>
		</li>
		<li class="comp-tab-item ">
