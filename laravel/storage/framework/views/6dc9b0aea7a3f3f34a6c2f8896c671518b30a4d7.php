...
<div class="course-infos">
    <div class="w pr">
        ...
        <div class="hd clearfix">
            <h2 class="l"><?php echo e($ke[0]->course_name); ?></h2>
                    </div>
        ...
        <div class="statics clearfix">
            ...
            <div class="static-item l">
                ...
                <span class="meta-value"><?php echo e($ke[0]->leve); ?></span>
                <em></em>
            </div>
            <div class="static-item l">
...
<div class="course-info-main clearfix w">
	...
	<input type="hidden" value="<?php echo e($kid); ?>" id="kid">
</div><!-- 课程面板 -->
     <div id="sh" >
     <?php foreach ($zhang as $key => $v) {?>
            ...
            <div class="mod-chapters" >
                    ...
                    <h3>
                        ...
                        <span class="js-close " id="<?php echo e($v->id); ?>" style="font-size:13px">▶</span>
                        <strong>
        ...
        $.ajax({
                ...
                success: function(msg){
                  ...
                  $(msg).each(function(k,v){
                       str+='<li class="ying"><a href="<?php echo e(url('course_bo')); ?>/'+v.id+'" class="J-media-item"><i class="icon-code type"></i>'+v.title+'<button class="r moco-btn moco-btn-red preview-btn" style="line-height:22px;">开始学习</button></a></li>';
                  })
                $(".video"+id).html(str)
                $('#'+id).html('▼');
                }
