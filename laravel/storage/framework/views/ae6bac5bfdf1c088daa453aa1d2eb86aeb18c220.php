                        ...
                        <div class="bd">
                            <ul class="">
                                ...
                                <?php foreach ($fang as $k => $v) {?>
                                        ...
                                        <a href="<?php echo e(url('course_so')); ?>/<?php echo e($v->id); ?>" data-ct="fe"><?php if ($v->id==$pid) {
                        ...
                        <div class="bd">
                            <ul class="">
                                ...
                                <li class="course-nav-item ">
                                                            <a href="<?php echo e(url('course_sofen')); ?>/<?php echo e($v->id); ?>"><?php if ($v->id==$fid) {
                                                               echo "<span style='color:red'>".$v->aspect_name."</span>";
                                                            }else{
                                                               echo $v->aspect_name;    
                                                                } ?></a>
                        ...
                        <div class="bd">
                            <ul class="">
                                ...
                                <?php foreach ($le as $key => $v) {?>
                                                              <li class="course-nav-item ">
                                        <a href="<?php echo e(url('course_sole')); ?>/<?php echo e($v->id); ?>"><?php  if ($v->id==$lx) {
